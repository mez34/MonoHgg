...
void saturationStudies::Loop()
{
  ...
  H_EOverEtrue_EB->GetXaxis()->SetTitle("E / Etrue");
  H_EOverEtrue_EE->GetXaxis()->SetTitle("E / Etrue");
  ...
  H_EOverEtrue_sat_EB->GetXaxis()->SetTitle("E / Etrue");
  H_EOverEtrue_sat_EE->GetXaxis()->SetTitle("E / Etrue");
  ...
  H_EOverEtrue_rec_EB->GetXaxis()->SetTitle("E / Etrue");
  H_EOverEtrue_rec_EE->GetXaxis()->SetTitle("E / Etrue");
  ...
  */
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if (tree5x5_kLeRecovered[ii]==1) 
	  cout << "more than 1 saturated xtal => ii " << ii 
	       << ", kSaturated[ii] = " << tree5x5_kLeRecovered[ii] << ", amplit = " << tree5x5_amplit[ii] << endl;
      }
    }
    ...
    if (fabs(energy_e5x5-myE5x5)>10) { 
      cout << energy_e5x5 << " " << myE5x5 << " " << fabs(energy_e5x5-myE5x5) << endl;
      for (int ii=0; ii<25; ii++) cout << tree5x5_amplit[ii] << endl;
    }
  ...
  cout << endl;
  cout << "# of events with central xtal saturated: "    << satEvents/totEvents   << endl;
  cout << "# of events with central xtal LE recovered: " << LErecEvents/totEvents << endl;
  cout << endl;
  cout << "# of events with a xtal close to central one saturated (but not the central one): "    << satEventsClose/totEvents   << endl;
  cout << "# of events with a xtal close to central one LE recovered (but not the central one): " << LErecEventsClose/totEvents << endl;
  cout << endl;
  ...
  leg->SetFillColor(0);
  leg->AddEntry(H_EOverEtrue_EB, "standard", "l");
  leg->AddEntry(H_EOverEtrue_sat_EB, "central xtal saturated", "l");
  leg->AddEntry(H_EOverEtrue_rec_EB, "central xtal recovered", "l");

  TLegend *leg2;
  leg2 = new TLegend(0.2,0.2,0.45,0.45);
  leg2->SetFillStyle(0);
  leg2->SetBorderSize(0);
  leg2->SetTextSize(0.05);
  leg2->SetFillColor(0);
  leg2->AddEntry(H_E5x5OverEtrue_EB, "standard", "l");
  leg2->AddEntry(H_E5x5OverEtrue_sat_EB, "central xtal not recovered", "l");
  leg2->AddEntry(H_E5x5OverEtrue_rec_EB, "central xtal LE recovered", "l");
  leg2->AddEntry(H_E5x5OverEtrue_NNrec_EB,  "central xtal NN recovered", "l");
