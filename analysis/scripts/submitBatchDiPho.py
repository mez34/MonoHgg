...
#######################################
    ...
    parser.add_option('-q', '--queue', action='store', dest='queue', help='run in batch in queue specified as option (default -q 8nm)', default='8nm')
    ...
    inputlist="lists_50ns_betaV4/"+dataset+".list"
    inputweights="lists_50ns_betaV4/"+dataset+".weight"
    output = dataset
    ...
    else: diskoutputdir = '/afs/cern.ch/user/m/mzientek/private/MonoHggCMSSW/CMSSW_7_4_6_patch2/src/MonoHgg/output'
