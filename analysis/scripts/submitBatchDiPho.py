...
#######################################
    ...
    inputlist="lists_25ns_v7/"+dataset+".list"
    inputweights="lists_25ns_v7/"+dataset+".weight"
    output = dataset
    ...
    else: diskoutputdir = '/afs/cern.ch/user/m/mzientek/private/MonoHggCMSSW/CMSSW_7_4_12/src/MonoHgg/output'
